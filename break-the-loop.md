---
title: Break the Loop Privacy Policy
layout: null
---

# Privacy Policy for Break the Loop
...
- intervention records, such as the date and time, urge intensity, selected emotion or trigger tags, coping actions, and optional private notes;
- self-reflections about sleep, focus, or mood;
...
If you choose to enable a daily reminder, the app requests notification permission and schedules a neutral reminder locally on your device. Private records, tags, intensity ratings, and notes are not included in notifications. On Android, the app also receives a system event after a restart or app update so that an enabled reminder can be scheduled again.

### Privacy Lock

If you enable the privacy lock, the app asks the operating system to verify you with biometrics or your device passcode. Break the Loop receives only the authentication result and does not receive or store biometric data.

### System Sharing

If you choose to share a suggested everyday message, the app opens the system share sheet. Break the Loop does not request access to your contacts, does not learn which person or service you selected, and does not receive the result of the share action.
...
We may update this Privacy Policy when the app’s features or privacy practices change. Updates will be posted on this page with a revised effective date.

## Contact

If you have questions about this Privacy Policy, contact:

[arion.dsh@gmail.com](mailto:arion.dsh@gmail.com)
